...
CC Switch for macOS is code-signed and notarized by Apple. You can download and install it directly without any additional steps. If you encounter issues with the fork build, try downloading the latest fork version from the [Releases page](https://github.com/dkfjtang/ccs-gateway-web/releases).
...
1. Visit [Fork GitHub Issues](https://github.com/dkfjtang/ccs-gateway-web/issues)
