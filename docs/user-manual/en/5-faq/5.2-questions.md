...
CC Switch for macOS is code-signed and notarized by Apple. For this fork, download the packaged build from the [Fork Releases page](https://github.com/dkfjtang/ccs-gateway-web/releases).
