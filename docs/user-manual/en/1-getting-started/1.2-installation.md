...
Only download this fork from **[Fork GitHub Releases](https://github.com/dkfjtang/ccs-gateway-web/releases)** or the project source repository. Any "CC Switch" site or client that asks for payment, top-ups, or login credentials is not an approved source for this fork.
...
1. Visit the [Fork Releases page](https://github.com/dkfjtang/ccs-gateway-web/releases)
