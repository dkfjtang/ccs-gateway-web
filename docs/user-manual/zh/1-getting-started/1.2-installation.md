...
请只从 **[Fork GitHub Releases](https://github.com/dkfjtang/ccs-gateway-web/releases)** 或项目源码仓库获取本 fork。任何要求付费、充值或索取登录凭据的“CC Switch”网站或客户端都不是本 fork 的认可渠道。
...
1. 访问 [Fork Releases 页面](https://github.com/dkfjtang/ccs-gateway-web/releases)
